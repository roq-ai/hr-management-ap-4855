  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of Human Resources with HR Management Application, your ultimate solution for seamless HR operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of Human Resources with HR Management Application, your ultimate solution for seamless HR operations.`}
            </Text>
            <Box
