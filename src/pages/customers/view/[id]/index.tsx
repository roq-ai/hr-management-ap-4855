        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Purchase History" text={data?.purchase_history} />
                ...
                <FormListItem
                  ...
                  text={
                    data?.last_purchase_date
                      ? format(parseISO(data?.last_purchase_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Favorite Product" text={data?.favorite_product} />

                <FormListItem label="Membership Level" text={data?.membership_level} />
