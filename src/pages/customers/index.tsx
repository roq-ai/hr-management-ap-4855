...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCustomers({
        ...
        order: params.order,
        searchTermKeys: ['purchase_history.contains', 'favorite_product.contains', 'membership_level.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'purchase_history', header: 'Purchase History', accessorKey: 'purchase_history' },
    { id: 'total_spent', header: 'total_spent', accessorKey: 'total_spent' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.last_purchase_date
          ? format(parseISO(record?.last_purchase_date as unknown as string), 'dd-MM-yyyy')
          : '',
    },
    { id: 'favorite_product', header: 'Favorite Product', accessorKey: 'favorite_product' },
    { id: 'membership_level', header: 'Membership Level', accessorKey: 'membership_level' },
